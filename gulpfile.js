...
// JS to watch
var jsFiles = ["./dev/js/**/*.js", "!./dev/js/dist/*.js"];

// Sass files to watch
var cssFiles = ["./dev/sass/**/*.scss"];

// automatically reloads the page when files changed
var browserSyncWatchFiles = ["./*.min.css", "./dev/js/**/*.min.js", "./**/*.php"];
...
gulp.task("scripts", function() {
  return (
    gulp
      .src("./dev/js/manifest.js")
      .pipe(include())
      .pipe(rename({ basename: "scripts" }))
      .pipe(gulp.dest("./dev/js/dist"))
